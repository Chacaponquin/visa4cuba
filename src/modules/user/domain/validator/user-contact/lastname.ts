  ...
  validate(): FormException[] {
    ...
    return validator.execute({
      empty() {
        return [
          new FormException({
            es: `Se debe definir un apellido para el autor del mensaje`,
            en: `A last name must be defined for the message author`,
            it: `Deve essere definito un cognome per l'autore del messaggio`,
          }),
        ];
      },
    });
