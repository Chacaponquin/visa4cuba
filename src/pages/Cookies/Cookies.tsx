    ...
    <Layout>
      ...
      <InformationContent>
        <P>
          ...
          when you use yourcubacar.com (hereinafter collectively referred to as
          "Website").
        </P>
        ...
        <P>
          ...
          <A link={APP_EMAIL.LINK}>{APP_EMAIL.EMAIL}</A>. The Data Protection
          Officer (hereinafter the “DPO”) pursuant to Art. 37 et seq. of the
          Regulation can be contacted via the email address:{" "}
