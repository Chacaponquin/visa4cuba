...
import Bed from "../../../../modules/app/modules/icon/components/Bed";
import Book from "../../../../modules/app/modules/icon/components/Book";
import Calendar from "../../../../modules/app/modules/icon/components/Calendar";
import Passport from "../../../../modules/app/modules/icon/components/Passport";
import Sad from "../../../../modules/app/modules/icon/components/Sad";
