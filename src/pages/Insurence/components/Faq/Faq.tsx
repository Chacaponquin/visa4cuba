import Avatar from "../../../../modules/app/modules/icon/components/Avatar";
import Forbid from "../../../../modules/app/modules/icon/components/Forbid";
...
import Sick from "../../../../modules/app/modules/icon/components/Sick";
...
export default function Faq() {
  return (
    ...
    >
      ...
      >
        <P>
          Sí. Desde el 30 de marzo de 2010, el gobierno cubano ha establecido
          que todos los viajeros extranjeros y cubanos que residen en el
          exterior al momento de su ingreso a Cuba deben contar con un seguro
          médico de viaje.
        </P>
      </FaqCard>
      ...
      >
        <P>
          Sí. Todos los viajeros, extranjeros y cubanos residentes en el
          exterior, deben estar en posesión de un seguro médico de viaje al
          ingresar a Cuba.
        </P>
      </FaqCard>
      ...
      >
        <P>
          ...
          obligatorio. El turista que, en contravención de la ley, logra
          ingresar a Cuba sin seguro médico corre un gran riesgo. De hecho, en
          caso de enfermedad o lesión, tendrá que pagar sus propias facturas
          médicas, que fácilmente pueden ascender a varios miles de dólares.
        </P>
      </FaqCard>
      ...
      >
        <P>
          ...
          médica por enfermedad, medicamentos ambulatorios o relacionados con
          una hospitalización, repatriaciones (sanitarias o funerarias),
          anticipo de fondos, gestión de documentos, diferencias de precio en el
          boleto aéreo por la pérdida del vuelo, entre otros.
        </P>
      </FaqCard>
      ...
      >
        <P>
          Con el seguro médico de ESICUBA, además de no tener que anticipar
          ningún gasto médico, tendrás acceso a las mejores clínicas
          internacionales en Cuba y tendrás una asistencia presencial muy rápida
          y eficiente. Cuáles son las clínicas internacionales a las que tienes
          acceso a través del seguro medico ? Haga clic aquí para ver todas las
          clínicas internacionales en Cuba con las que puede contactar en caso
          de necesidad presentando nuestro seguro
        </P>
      </FaqCard>
      ...
      >
        <P>
          El seguro se puede contratar para viajes que tengan una duración
          máxima de 32 días. Si su viaje tiene una duración mayor, contáctenos
          para un presupuesto personalizado.
        </P>
      </FaqCard>
    </LayoutSection>
